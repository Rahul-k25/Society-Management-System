...
<body>
 ...
 <div class="D" style="float: right;
  margin-left:10px;">
	...
	<a href="../User/storeduser.php" >Other Residents</a>

  <a href="securitylogin.php" >Log Out</a>
	</div>
...
<nav class="B" id="mySidebar">
  ...
  <a  href="../Visitor/visitordetails.php?sid=<?php echo $_SESSION['sid'] ?>">Add Visitor</a><br><br>
